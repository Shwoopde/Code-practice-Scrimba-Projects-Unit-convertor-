...
createInvoiceButtonId.addEventListener('click', printPDF);
...
// createInvoiceButtonId.addEventListener('click', () => {
//     const invoice = {
//         carWashPrice: `$${carWash}`,
//         carWash: carWashQuantity,
//         lawnMowingPrice: `$${lawnMowing}`,
//         lawnMowing: lawnMowingQuantity,
//         weedPullingPrice: `$${pullWeeds}`,
//         pullWeeds: pullWeedsQuantity,
//         notes: textAreaId.value,
//         total: total
//     }
//     resetQuantities();
//     calculateTotal();
